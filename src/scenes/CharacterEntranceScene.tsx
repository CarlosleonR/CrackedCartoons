...
export const CharacterEntranceScene: React.FC<{
  ...
  return (
    <AbsoluteFill>
      <PicnicBackground />
      {sandwiches[0] && <Sandwich variant={sandwiches[0]} x={140} y={1380} scale={1.4} rotate={-4} />}
      {sandwiches[1] && <Sandwich variant={sandwiches[1]} x={460} y={1340} scale={1.4} rotate={2} />}
      {sandwiches[2] && <Sandwich variant={sandwiches[2]} x={740} y={1380} scale={1.4} rotate={-1} />}
